    ...
    resources: {
        en: {
            ...
            articleDetails: {
                ...
                'Оберіть категорію': '*Select at least one category.',
                'Додайте блок': '*Add at least one block',
                'Видалити всі': 'Delete all',
                'Назва зображення': 'Image title (required)',
                'Помилка завантаження файлу':
                    'File upload error. Please try again.',
                'Спробувати повторно': 'Upload Again',
                'Помилка збереження статті':
                    'Failed to save article due to server error',
                'Помилка сервера при збереженні данних':
                    'Server error while saving data. Please try again',
                'Редагування статті': 'Edit article',
                блок: 'Block',
            },
            profile: {
        ...
        uk: {
            ...
            articleDetails: {
                ...
                'Оберіть категорію': '*Оберіть щонайменше одну категорію.',
                'Додайте блок': '*Додайте щонайменше один блок',
                'Видалити всі': 'Видалити всі',
                'Назва зображення': "Назва зображення (обов'язково)",
                'Помилка завантаження файлу':
                    'Помилка завантаження файлу. Будь ласка, спробуйте ще раз.',
                'Спробувати повторно': 'Спробувати повторно',
                'Помилка збереження статті': 'Помилка збереження статті',
