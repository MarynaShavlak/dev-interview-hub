...
export const problemsDataUkr = [
    {
        title: 'Розкидана й неструктурована підготовка',
        text:
            'Попрощайся з випадковими закладками, безладом у документах та хаотичними нотатками. ' +
            'Dev Interview Hub об’єднує всю підготовку до співбесід в одну зручну та зрозумілу систему.',
        value: 'Централізована та структурована підготовка.',
    },
    {
        title: 'Відсутність фокусованої практики та відстеження прогресу',
        text:
            'Жодного більше навчання наосліп. Відстежуй, на які запитання вже відповідав, що ще варто опрацювати,' +
            ' і слідкуй за зростанням у своєму особистому дашборді з фільтрами.',
        value: 'Ясність і контроль над підготовкою.',
    },
    {
        title: 'Неможливість створити зручну базу знань для розробника',
        text:
            'Створюй власну базу знань з фільтрами та пошуком — з кодом, зображеннями й підтримкою кількох мов —' +
            ' спеціально для підготовки до співбесід на фронтенд.',
        value: 'Зручне створення контенту для розробників.',
    },
    {
        title: 'Брак зворотного зв’язку та підтримки спільноти',
        text: 'Готуватись самостійно до співбесіди непросто. Оцінки, коментарі та відгуки від інших допомагають прокачати знання й перевірити себе.',
        value: 'Вчись разом зі спільнотою розробників.',
    },
    {
        title: 'Страх перед співбесідами та відсутність репетицій',
        text: 'Тренуйся у комфортному просторі: пиши, редагуй і вдосконалюй свої відповіді на реальні питання без тиску й скільки завгодно разів.',
        value: 'Упевненість через практику й повторення.',
    },
    {
        title: 'Надійне та безпечне збереження даних',
        text: 'Хвилюєшся, що щось загубиться? Усі твої дані зберігаються безпечно у Firebase — завжди доступні й під рукою.',
        value: 'Спокій для серйозної роботи з контентом.',
    },
    {
        title: 'Забуваєш круті питання, які десь почув',
        text: 'Миттєво зберігай цікаві питання у свою чергу — хоч з відео, хоч зі статті чи вебінару — й повертайся до них, коли зручно.',
        value: 'Фіксуй важливе одразу аби не загубити',
    },
    {
        title: 'Неможливо визначити, що справді важливо',
        text: 'Сортуй матеріали за переглядами, рейтингом, категорією чи датою — і фокусуйся на тих темах, які справді часто питають.',
        value: 'Розумні пріоритети у підготовці.',
    },
    {
        title: 'Погана навігація й плутанина в темах',
        text:
            'Наша система з 10 категорій (React, JS тощо) допомагає структурувати матеріали, вносить порядок у нотатки' +
            ' і дає змогу краще бачити, на чому зосередитись.',
        value: 'Зручна організація й навігація.',
    },
    {
        title: 'Постійний пошук одного й того ж',
        text:
            'Розробники витрачають купу часу, шукаючи те саме знову й знову. ' +
            'Dev Interview Hub зібрав найпоширеніші питання в одному місці — з пошуком, категоріями й зручним поверненням до них.',
        value: 'Економія часу й розумових зусиль.',
    },
];
