...
7. **Test for [fetchArticlesList](../src/pages/ArticlesPage/model/services/fetchArticlesList/fetchArticlesList.test.ts) thunk**:
...
8. **Test for [fetchNextArticlesPage](../src/pages/ArticlesPage/model/services/fetchNextArticlesPage/fetchNextArticlesPage.test.ts) thunk**:
